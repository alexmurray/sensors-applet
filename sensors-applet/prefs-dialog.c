...
void prefs_dialog_open(SensorsApplet *sensors_applet) {
	...
	content_area = gtk_dialog_get_content_area (prefs_dialog->dialog);
        ...
        gtk_combo_box_text_append_text(
		GTK_COMBO_BOX_TEXT(prefs_dialog->layout_mode_combo_box), _("beside labels / icons"));
        gtk_combo_box_text_append_text(
        ...
        gtk_combo_box_text_append_text(
		GTK_COMBO_BOX_TEXT(prefs_dialog->temperature_scale_combo_box), _("Kelvin"));
        gtk_combo_box_text_append_text(
		GTK_COMBO_BOX_TEXT(prefs_dialog->temperature_scale_combo_box), _("Celsius"));
        gtk_combo_box_text_append_text(
		GTK_COMBO_BOX_TEXT(prefs_dialog->temperature_scale_combo_box), _("Fahrenheit"));
